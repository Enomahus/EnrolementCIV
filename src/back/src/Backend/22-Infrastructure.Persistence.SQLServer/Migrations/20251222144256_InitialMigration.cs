        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6L, "AD", "+376", "Andorre" },
                    { 7L, "AO", "+244", "Angola" },
                    { 8L, "AI", "+1-264", "Anguilla" },
                    { 9L, "AQ", "672", "Antarctique" },
                    { 10L, "AG", "+1-268", "Antigua-et-Barbuda" },
                    ...
                    { 18L, "BS", "+1-242", "Bahamas" },
                    { 19L, "BH", "+973", "Bahreïn" },
                    { 20L, "BD", "+880", "Bangladesh" },
                    { 21L, "BB", "+1-246", "Barbade" },
                    { 22L, "BE", "+32", "Belgique" },
                    { 23L, "BZ", "+501", "Belize" },
                    { 24L, "BJ", "+229", "Bénin" },
                    { 25L, "BM", "+1-441", "Bermudes" },
                    { 26L, "BT", "+975", "Bhoutan" },
